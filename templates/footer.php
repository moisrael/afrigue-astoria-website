            ...
            <div class="col-md-6">
                <div class="widget widget_about margin-bottom-25">
                    <div class="margin-bottom-35">
                        <img src="assets/img/afrigue-astoria-logo.png" width="204" height="30" alt="Afrigue Astoria Limited" />
                    </div>
                    <p>A Trailblazer in Durable and Reliable Construction Services.</p>
                </section>
    ...
    <div id="bottom-bar-inner" class="wprt-container">
        <div class="bottom-bar-inner-wrap">
            ...
            <div class="bottom-bar-content">
                <div id="copyright">AFRIGUE ASTORIA
                </div><!-- /#copyright -->
